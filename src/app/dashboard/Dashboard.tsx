            ...
            <div className={style.left__buttons}>
              ...
              <div className={style.dropdown}>
                ...
                >
                  ...
                  {selectedOption1}
                  <span
                    className={`${style.arrow__icon} ${dropdownOpen1 ? style.open : ''}`}
                  >
                    <ArrowDownIcon />
                  </span>
                </button>
              ...
              <div className={style.dropdown}>
                ...
                >
                  ...
                  <span
                    className={`${style.arrow__icon} ${dropdownOpen2 ? style.open : ''}`}
                  >
                    <ArrowDownIcon />
                  </span>
                </button>
...
const ArrowDownIcon = () => (
    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="#4A4A4A">
      <path d="M0 0h24v24H0z" fill="none" />
